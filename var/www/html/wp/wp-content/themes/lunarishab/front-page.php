...
<?php if( is_home()) : ?>
  <section class="kv">
    ...
    <div class="kv_slider js-slider">
      <div class="kv_sliderItem" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/img/home/kv-01@2x.jpg');"></div>
      <div class="kv_sliderItem" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/img/home/kv-02@2x.jpg');"></div>
      <div class="kv_sliderItem" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/img/home/kv-03@2x.jpg');"></div>
    </div>
    ...
    <div class="section_inner">
      <div class="section_headerWrapper">
        ...
        <div class="section_pic">
          <div><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/home/concept_img01@2x.png" alt=""></div>
          <div><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/home/concept_img02@2x.png" alt=""></div>
          <div><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/home/concept_img03@2x.png" alt=""></div>
        </div>
      </div>
...
?>
  ...
  <section class="section section-info">
    <div class="section_inner">
      ...
      <div class="section_pic">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/home/info_img01@2x.png" alt="">
      </div>
    </div>
  </section>
    ...
    <div class="section_inner">
      <div class="section_content">
        ...
        <div class="section_body">
          ...
          <div class="section_btn">
            <a href="<?php echo get_the_permalink(32);?>" class="btn btn-primary">アクセスはこちら</a>
          </div>
        </div>
      </div>
      <div class="section_pic">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/home/access_img01@2x.png" alt="">
      </div>
    </div>
  </section>
